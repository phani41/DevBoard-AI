...
class OpenRouterService:
    ...
    def _generate(self, system_prompt: str, user_prompt: str) -> str:
        if not self.enabled:
            return "AI service is not configured. Please set OPENROUTER_API_KEY in your environment variables."

        headers = {
            "Authorization": f"Bearer {self.api_key}",
            "Content-Type": "application/json",
            "HTTP-Referer": "https://devboard-ai.app",
            "X-OpenRouter-Title": "DevBoard AI",
        }
    ...
    def task_breakdown(self, task_title: str, description: Optional[str] = None) -> dict:
        system_prompt = "You are a project management AI assistant. Break down tasks into actionable subtasks."
        user_prompt = f"""
...
"""
    ...
    def explain_bug(self, error_message: str, code_context: Optional[str] = None) -> dict:
        system_prompt = "You are a debugging AI assistant. Analyze errors and provide detailed explanations with solutions."
        user_prompt = f"""
Error Message:
{error_message}
...
"""
    ...
    def generate_documentation(self, project_name: str, description: str, features: List[str], doc_type: str = "readme") -> str:
        system_prompt = "You are a technical documentation expert. Generate clean, professional documentation."
